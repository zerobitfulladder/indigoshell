...
Pure data, with one piece of behaviour: the colour helper parses each
hex string once into Skia's packed ARGB int and caches it, so paint code
never parses a string per frame.
"""
