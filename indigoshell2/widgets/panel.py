...
This is the two-layer split v1 arrived at and it's worth keeping: the
DSL items are immutable *descriptions*, and widgets are the live objects
they're interpreted into. Config authors write descriptions; only the
...
class Panel(Widget):
    animation_fps = 4          # v1 refreshed live items every 250ms
