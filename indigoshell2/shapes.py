...
at 45° rather than rounded. Ported from v1's `beveled_path`, but returning
a `skia.Path` instead of mutating a cairo context, which means the same
path can stroke the border, clip the backdrop, and hit-test the widget.
"""
