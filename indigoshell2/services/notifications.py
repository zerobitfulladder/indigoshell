...
The UI is decoupled — this module is "just" a D-Bus adapter, same as
v1's. The notification manager owns one instance and supplies the
...
class NotificationServer:
    ...
    async def start(self) -> None:
        ...
        daemon (dunst, v1) owns it we stay exported but inert — `active`
